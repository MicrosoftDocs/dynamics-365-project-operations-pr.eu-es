---
title: Proiektuetan oinarritutako kontratuen goiburuaren xehetasunak
description: Artikulu honek eremuei eta proiektuetan oinarritutako kontratuei buruzko informazioa eskaintzen du Project Operations-en.
author: rumant
ms.date: 10/20/2020
ms.topic: article
...
ms.locfileid: "9824285"
---
# <a name="header-details-for-project-based-contracts"></a>Proiektuetan oinarritutako kontratuen goiburuaren xehetasunak
...
| Bezeroa | **Laburpena** fitxa | Bezeroaren enpresaren edo kontuaren erregistroaren erreferentzia. Eskaintza batetik kontratua bat sortzen denean, eremu hori eskaintzaren erregistroan dagokion eremutik kopiatzen da. | Proiektuaren kontratu lehenetsiko moneta dago bezeroaren monetan oinarrituta. Moneta ezin da aldatu kontratua gorde baino lehen. |
...
| Erregistratutako kopurua | Proiektuetan oinarritutako linea baten xehetasuna | Denbora: eginkizun baterako kontratuaren lerro honetan mapatutako proiektuan erregistratutako denbora guztiaren kostuaren guztizko zenbatekoa. Gastuak: Proiektuko gastuen benetako datuetako gastuen kategoria honetarako kopuru guztiak kontratuaren lerroan mapatzen dira. |
