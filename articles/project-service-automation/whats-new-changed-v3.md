...
1.  **Baliabide erreserbagarriak**, hau da **Denbora-sarrera** entitatearen eremua, ez dagoenez agerian **Sorrera bizkorra** orrialdean, gehitu behar duzu.
    ...
    Sortu ikuspegi pertsonalizatua baliabiderako sortu diren denbora-sarrerak ikusteko. Argitaratu aplikazio moduluen diseinatzailean pertsonalizazioak ikuspegi hau **Ikusi hautatzailea** aukeraren behean erakusteko **Denbora-sarrerak** orrian. Proiektuaz kanpoko denbora-sarrerak dituen kudeatzailearen ezarpena kudeatzen dituzten bi plugin daude:
