...
Baliabideak antolatu inplementazioan laguntzeko bilatzen? Deskarga gidak horiek babesa.
 ...
 [Proiektua antolamendu- eta jarraipen-gida](../project-service/implementation-guides/project-planning-tracking.md)

 [Oinarrizko quoting, prezio- eta fakturazio-gida](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Quoting aurreratua, prezio- eta fakturazio-gida](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Baliabide-kudeatzailearen gida](../project-service/implementation-guides/resource-management-guide.md)

 [Txosten-gida](../project-service/implementation-guides/reporting-guide.md)

 [Garatzaileentzako oharrak](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Zaharragoetan guidance (aplikazioaren bertsioa 2.x edo 1.x)
 ...
 [Denbora, gastuak eta lankidetza](../project-service/time-expense-collaboration-guide.md)

 [Paper zuriak (aplikazioaren 2.x edo 1.x bertsioa)](../project-service/white-papers.md)

 [Garatzaileentzako oharrak (2.x aplikazioaren bertsioa)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
