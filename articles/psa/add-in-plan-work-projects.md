...
---
# <a name="plan-your-work-in-microsoft-project-with-the-project-service-add-in"></a>Antolatu zure lana Microsoft Project-en Project Service osagarriarekin
...
2.  Hautatu deskargatu esteka.  

3.  Deskarga amaitzen denean, hautatu **Bai** gehigarria instalatzeko.  

## <a name="configure-the-add-in"></a>Konfiguratu osagarria  

1. Ireki [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] eta hautatu **Project Service** fitxa.  

2. Hautatu **Konektatu**.  

3. Sartu zure saio-informazioa eta, ondoren, hautatu **Saioa**.  
...
1.  **Project Service** fitxan, hautatu **Irakurri** > **Project Service Automation proiektu-txantiloia**.  

2.  Aukeratu proiektua txantiloi bat zerrendatik eta, ondoren, hautatu **Ireki**.  
...
1.  Ireki proiektua bat eta hautatu **Zeregina** zinta.  

2. Hautatu **Gantt diagrama** menua eta, ondoren, aukeratu **Baliabide Orria**.  

3. Baliabide-Orria, hautatu **Project Service Automation Baliabide Funtzioak** goitibeherako menuan eta hautatu Project Service Automation funtzio bat.  

## <a name="staff-your-project-with-resources"></a>Zure proiektua baliabideekin staff  

1.  Project Service fitxan aurki daiteke, errenkada bat hautatu eta hautatu **Bilaketa-baliabideak**.  

2.  Atalean, **Liburua Baliabide** pantailan, hautatu proiektuan erabili nahi duzun baliabidea.  

3.  Hautatu **Erreserbatu** eta ondoren hautatu **Ados**.  
...
1. **Project Service** fitxan, joan **Argitaratu** > **Project Service Automation berria** aukerara.  

2. **Project Service-n proiektu berria argitaratu** elkarrizketa-koadroan, idatzi- **Proiektuaren izena** eta hautatu **Bezeroa**.  

3. Nahi izanez gero, hautatu **Estekatu proiektu-plana Project Service Automation-era** Proiektua fitxategiaren plana Project Service Automation-era estekatzeko.  

4. Hautatu **Argitaratu**.  
...
### <a name="edit-in-pn_microsoft_project"></a>Editatu [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)]-en  

1. Menu nagusian, joan **Project Service** > **Proiektuak** aukerara.  

2. Proiektuen zerrendan, ireki [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] aplikazioan sortu duzuna.  

3. Hautatu **Ireki MS Project** zintaren batetik. Estekatutako fitxategi nagusia irekiko da [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)]-en.  
...
3. Hautatu **Kendu esteka MS Project-ik** zintaren batetik.  
...
1. Menu nagusian, joan **Project Service** > **Kargatu** aukerara.  

2. Hautatu **Project Service Automation proiektuaren dokumentuak**.  

3. **Gaitu Ireki [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)]** elkarrizketa-koadroan, hautatu **Bai** edo **Ez**.  
   ...
   - **Ez** hautatzen baduzu, **Ireki [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)]** estekak ez du funtzionatuko.  
...
## <a name="publish--your-project-as-a-template"></a>Zure proiektua txantiloi gisa argitaratu  
 Zure proiektua gorde dezakezu eta aplikazioan proiektua txantiloi gisa gorde arabera erabiltzeko [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)]. Aplikazioan antzekoentzat proiektua planak dira proiektua txantiloiak [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)]. Informazio gehiagorako, ikusi [Sortu proiektuaren txantiloia (Project Service Automation)](../psa/create-project-template.md). 

1. **Project Service** fitxan, joan **Argitaratu** > **Project Service Automation-en proiektu-txantiloi berria** aukerara.  

2. **Project Service-n proiektu txantiloia argitaratu** elkarrizketa-koadroan, idatzi- **Proiektu-txantiloiaren izena**.  

3. Nahi izanez gero, hautatu **Estekatu proiektu-plana Project Service Automation-era** Proiektua fitxategia [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)]-ra estekatzeko.  
...
Atal honetako taulek Project Service Automation eta Microsoft Project mahaigaineko gehigarriaren entitateen datuak sinkronizatzeari buruzko informazioa eskaintzen dute.

### <a name="project-task-entity-table"></a>Project Task entitate taula
Hurrengo taulan Proiektuaren zeregina entitatearen datuak Project Service Automation eta Microsoft Project mahaigaineko gehigarriaren artean nola sinkronizatzen diren azaltzen da.

| **Entitatea** | **Eremua** | **Microsoft Project Project Service Automation-en** | **Project Service Automation Microsoft Project-en** |
| --- | --- | --- | --- |
| Proiektuaren zeregina | Epemuga | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Aurreikusitako ahalegina | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | MS Project bezeroaren IDa | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Zeregin nagusia | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Project | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Proiektuaren zeregina | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Proiektuaren zereginaren izena | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Baliabidearen unitatea (zaharkitua 3.0 bertsioan) | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Antolatutako iraupena | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | Hasiera-data | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuaren zeregina | WBS IDa | Sinkronizatuta | Sinkronizatu gabe |

### <a name="team-member-entity-table"></a>Team Member entitate-taula
Hurrengo taulan Team Member entitatearen datuak Project Service Automation eta Microsoft Project mahaigaineko gehigarriaren artean nola sinkronizatzen diren azaltzen da.

| **Entitatea** | **Eremua** | **Microsoft Project Project Service Automation-en** | **Project Service Automation Microsoft Project-en** |
| --- | --- | --- | --- |
| Taldeko kidea | MS Project bezeroaren IDa | Sinkronizatuta | Sinkronizatu gabe |
| Taldeko kidea | Lanpostuaren izena | Sinkronizatuta | Sinkronizatu gabe |
| Taldeko kidea | proiektua | Sinkronizatuta | Sinkronizatuta |
| Taldeko kidea | Proiektu-taldea | Sinkronizatuta | Sinkronizatuta |
| Taldeko kidea | Baliabide-unitatea | Sinkronizatu gabe | Sinkronizatuta |
| Taldeko kidea | Funtzioa | Sinkronizatu gabe | Sinkronizatuta |
| Taldeko kidea | Lanorduak | Sinkronizatu gabe | Sinkronizatu gabe |

### <a name="resource-assignment-entity-table"></a>Baliabideak esleitzeko entitate-taula
Hurrengo taulan Baliabideak esleitzeko entitatearen datuak Project Service Automation eta Microsoft Project mahaigaineko gehigarriaren artean nola sinkronizatzen diren azaltzen da.

| **Entitatea** | **Eremua** | **Microsoft Project Project Service Automation-en** | **Project Service Automation Microsoft Project-en** |
| --- | --- | --- | --- |
| Baliabide-esleipena | Hasiera-data | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | ordu | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | MS Project bezeroaren IDa | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | Planifikatutako lana | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | Project | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | Proiektu-taldea | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | Baliabide-esleipena | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | Ataza | Sinkronizatuta | Sinkronizatu gabe |
| Baliabide-esleipena | Amaiera-data | Sinkronizatuta | Sinkronizatu gabe |

### <a name="project-task-dependencies-entity-table"></a>Project Task mendekotasunen entitate taula
Hurrengo taulan Project Task mendekotasunak esleitzeko entitatearen datuak Project Service Automation eta Microsoft Project mahaigaineko gehigarriaren artean nola sinkronizatzen diren azaltzen da.

| **Entitatea** | **Eremua** | **Microsoft Project Project Service Automation-en** | **Project Service Automation Microsoft Project-en** |
| --- | --- | --- | --- |
| Proiektuen zereginen mendekotasunak | Proiektuaren zereginen mendekotasuna | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuen zereginen mendekotasunak | Esteka mota | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuen zereginen mendekotasunak | Aurreko zeregina | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuen zereginen mendekotasunak | Project | Sinkronizatuta | Sinkronizatu gabe |
| Proiektuen zereginen mendekotasunak | Hurrengo zeregina | Sinkronizatuta | Sinkronizatu gabe |
